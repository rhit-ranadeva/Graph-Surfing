...
public class GraphSurfingMilestone2Test {
	...
	public void testWikiSurfingShortestPath() {
		...
		List<String> path4 = livingPeopleALGraph.shortestPath("Lance Armstrong", "Britney Spears");
		...
		List<String> path5 = livingPeopleALGraph.shortestPath("Mike Pence", "50 Cent");
		...
		List<String> path9 = livingPeopleALGraph.shortestPath("Redd Pepper", "John Salt");
		...
		List<String> path16 = livingPeopleALGraph.shortestPath("Tony Hoare", "Donald Knuth");
		...
		List<String> path0 = livingPeopleALGraph.shortestPath("John Salt", "Redd Pepper");
